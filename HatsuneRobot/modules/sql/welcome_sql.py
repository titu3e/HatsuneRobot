...
from HatsuneRobot.modules.helper_funcs.msg_types import Types
from HatsuneRobot.modules.sql import BASE, SESSION
from sqlalchemy import Boolean, Column, Integer, String, UnicodeText
from sqlalchemy.sql.sqltypes import BigInteger

DEFAULT_WELCOME_MESSAGES = "Hey {first}, Welcome to {chatname}! how are you?"
DEFAULT_GOODBYE_MESSAGES = "Nice To Know You Gey😏!"
