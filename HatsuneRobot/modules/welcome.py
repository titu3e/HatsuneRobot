...
import HatsuneRobot.modules.sql.welcome_sql as sql
from HatsuneRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
...
from HatsuneRobot.modules.helper_funcs.msg_types import get_welcome_type
