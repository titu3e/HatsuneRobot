...
from HatsuneRobot import dispatcher, telethn
from HatsuneRobot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
                                   HELPABLE, IMPORTED, MIGRATEABLE, STATS,
                                   USER_INFO, USER_SETTINGS)
from HatsuneRobot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("HatsuneRobot.modules.", 1)[1]
