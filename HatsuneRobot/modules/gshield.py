...
from HatsuneRobot.services.telethonbasics import is_admin
from HatsuneRobot.events import register
from pymongo import MongoClient
from HatsuneRobot.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from HatsuneRobot import telethn as tbot, MONGO_DB_URI, BOT_ID
