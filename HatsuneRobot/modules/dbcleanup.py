...
import HatsuneRobot.modules.sql.global_bans_sql as gban_sql
import HatsuneRobot.modules.sql.users_sql as user_sql
from HatsuneRobot import DEV_USERS, OWNER_ID, dispatcher
