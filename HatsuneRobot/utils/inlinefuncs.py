...
from HatsuneRobot import arq
from HatsuneRobot.services.keyboard import Ikb
from HatsuneRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from HatsuneRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from HatsuneRobot.services.types import InlineQueryResultCachedDocument
from HatsuneRobot.modules.info import get_chat_info, get_user_info
from HatsuneRobot.modules.music import download_youtube_audio
from HatsuneRobot.utils.functions import test_speedtest
from HatsuneRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Hatsune Miku Robot ❤️](https://t.me/HatsuneMikuRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
