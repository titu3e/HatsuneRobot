...
import sys
import traceback
import HatsuneRobot.modules.sql.users_sql as sql
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("HatsuneRobot.modules." + module_name)
...
def hatsune_about_callback(update, context):
    ...
    if query.data == "hatsune_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Back​", callback_data="hatsune_back"
                        ),
                    ],
                ]
            ),
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back​", callback_data="hatsune_")]]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ʟᴏɢs​", url="t.me/HatsuneMikuProject"),
                        InlineKeyboardButton(
                            text="ғᴇᴅᴇʀᴀᴛɪᴏɴ​", url="https://t.me/HatsuneMikuProject"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="Back​", callback_data="hatsune_"),
